Reveal.addEventListener("ready", function() {
  ...
  QUnit.test("Vertical separator", function(assert) {
    assert.strictEqual(
      ...
      6,
      "found six vertical slides"
    );
  });

  QUnit.test("Id on slide", function(assert) {
    assert.strictEqual(
      document.querySelectorAll(".reveal .slides>section>section#slide2")
        .length,
      1,
  ...
  QUnit.test("data-background attributes with default separator", function(
    assert
  ) {
    assert.strictEqual(
      document.querySelectorAll(
  ...
  QUnit.test("data-transition attributes with default separator", function(
    assert
  ) {
    assert.strictEqual(
      document.querySelectorAll(
