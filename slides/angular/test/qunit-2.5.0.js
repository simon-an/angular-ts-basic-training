...
(function(global$1) {
    ...
    var reName = /^function (\w+)/,
      dump = {
        ...
        parse: function parse(obj, objType, stack) {
          ...
          parserType =
            typeof parser === "undefined" ? "undefined" : _typeof(parser);
    ...
    createClass(TestReport, [
      ...
      },
      {
        ...
        value: function getStatus() {
          ...
          var testPassed =
            this.getFailedAssertions().length > 0 ? this.todo : !this.todo;
      ...
      var runHook = function runHook() {
        ...
        if (
          ...
          hookOwner.unskippedTestsRun !==
            numberOfUnskippedTests(hookOwner) - 1 &&
    ...
    createClass(Assert, [
      ...
      },
      {
        ...
        value: function push(result, actual, expected, message, negative) {
          ...
          var currentAssert =
            this instanceof Assert ? this : config.current.assert;
      ...
      },
      {
        ...
        value: function pushResult(resultInfo) {
          ...
          var assert = this;
          var currentTest =
            (assert instanceof Assert && assert.test) || config.current;
      ...
      },
      {
        ...
        value: function throws(block, expected, message) {
          ...
          var currentTest =
            (this instanceof Assert && this.test) || config.current;
        ...
        value: function rejects(promise, expected, message) {
          ...
          if (objectType(expected) === "string") {
            if (message === undefined) {
              ...
              message =
                "assert.rejects does not accept a string value for the expected " +
              ...
              if (actual) {
                ...
                if (expected === undefined) {
                  ...
                  if (expectedType === "function") {
                    ...
                    result = false;
                    message =
                      "invalid expected value provided to `assert.rejects` " +
                      'callback in "' +
                      currentTest.testName +
                      '": ' +
                      expectedType +
  ...
  function createModule(name, testEnvironment, modifiers) {
    ...
    var skip$$1 =
      (parentModule !== null && parentModule.skip) || modifiers.skip;
    var todo$$1 =
      (parentModule !== null && parentModule.todo) || modifiers.todo;
  ...
  (function() {
    ...
    function appendToolbar() {
      ...
      if (toolbar) {
        ...
        toolbar.appendChild(document$$1.createElement("div")).className =
          "clearfix";
      }
    }
