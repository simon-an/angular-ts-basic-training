Reveal.addEventListener("ready", function() {
  ...
  QUnit.test("Attributes on element header in vertical slides", function(
    assert
  ) {
    assert.strictEqual(
  ...
  QUnit.test("Attributes on element paragraphs in vertical slides", function(
    assert
  ) {
    assert.strictEqual(
      document.querySelectorAll(
  ...
  QUnit.test("Attributes on element list items in vertical slides", function(
    assert
  ) {
    assert.strictEqual(
      document.querySelectorAll(
  ...
  QUnit.test("Attributes on element paragraphs in horizontal slides", function(
    assert
  ) {
    assert.strictEqual(
      document.querySelectorAll(
  ...
  QUnit.test("Attributes on element list items in horizontal slides", function(
    assert
  ) {
    assert.strictEqual(
      document.querySelectorAll(
  ...
  QUnit.test("Attributes on element image in horizontal slides", function(
    assert
  ) {
    assert.strictEqual(
